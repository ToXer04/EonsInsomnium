...
func become_host():
	...
	multiplayer.peer_connected.connect(func(): get_tree().call_group("MainMenu", "update_lobby_players_ui"))
...
func get_lobby_members() -> Array:
	...
	var member_count = Steam.getNumLobbyMembers(_hosted_lobby_id)
	for i in range(member_count):
		var steam_id = Steam.getLobbyMemberByIndex(_hosted_lobby_id, i)
		if steam_id:
